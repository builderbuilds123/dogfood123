...
export function BlackholeScene({
  ...
  return (
    <div className="relative min-h-[100dvh] w-full flex flex-col overflow-hidden">
      ...
      <Link
        href="/settings"
        className="fixed top-4 right-4 z-30 w-9 h-9 rounded-full bg-surface-light/40 backdrop-blur-md border border-border/30 hover:border-neon-violet/40 flex items-center justify-center text-foreground/30 hover:text-foreground/60 transition-colors mr-[env(safe-area-inset-right)]"
      >
